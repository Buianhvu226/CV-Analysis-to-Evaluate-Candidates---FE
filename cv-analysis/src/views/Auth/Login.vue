    ...
    <div class="w-full flex justify-center items-center">
      ...
      >
        ...
        <div class="hidden md:flex bg-[#4318D1] text-white w-5/12 flex-col">
          ...
          <div class="flex-1 p-8 flex flex-col justify-center">
            <div class="h-full flex flex-col justify-center">
              <h2 class="text-3xl font-bold mb-6">Find Your Dream Job Today</h2>
        ...
        <div class="w-full md:w-7/12 p-6 md:p-10 overflow-y-auto max-h-screen">
          ...
          <div v-if="formData.userType === 'candidate'">
          ...
          <div v-if="formData.userType === 'recruiter'">
          ...
          <form @submit.prevent="handleSubmit">
            ...
            <div class="mb-8">
              ...
              <div class="flex justify-end mt-2">
                <router-link
                  to="/home"
                  class="text-sm text-[#4318D1] hover:underline"
                >
                  Forgot password?
                </router-link>
              </div>
          ...
          <!-- Register Link - Only show for candidates -->
          <p
            v-if="formData.userType === 'candidate'"
